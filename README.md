...
The editorial substrate (signed benchmark runs, methodology, canonical article Markdown) lives at [Vargix/silicon-logic](https://github.com/Vargix/silicon-logic). This repo is the renderer that turns that substrate into a publication readers can read.
...
The committed public key, the canonical methodology, and every signed `BenchmarkRun` live in the [main repository](https://github.com/Vargix/silicon-logic). See [`docs/methodology.md`](https://github.com/Vargix/silicon-logic/blob/main/docs/methodology.md) for how runs are produced, aggregated, signed, and verified.
